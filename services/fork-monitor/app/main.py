...
from web3.middleware import geth_poa_middleware #import needed for poa-chains
...
# rewrite-the most inner layer is to be filled with 0 (see line 5) to act with poa-chains
# https://web3py.readthedocs.io/en/stable/middleware.html#geth-style-proof-of-authority for details
# assistance made it possiblehttps://web3py.readthedocs.io/en/stable/middleware.html#geth-style-proof-of-authority
